...
export function PortalShell({
  ...
  return (
    <div className="flex min-h-screen bg-background text-foreground">
      <aside className="hidden h-screen w-80 shrink-0 border-r border-border/70 bg-sidebar/70 lg:block">
      ...
      <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
        <SheetContent
          side="left"
          className="w-[88vw] max-w-84 overflow-hidden border-r border-border/70 bg-sidebar p-0"
        >
